...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210608195455_create database")]
            ...
            modelBuilder.Entity("Models.Channel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f8f41e4-86b7-45d3-a28a-294fd22ff25d"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 596, DateTimeKind.Local).AddTicks(6013),
                            Name = "SHOP",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 598, DateTimeKind.Local).AddTicks(5381)
                        },
                        new
                        {
                            Id = new Guid("293db361-ff59-42e5-9cd3-4193ee092e71"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 598, DateTimeKind.Local).AddTicks(7025),
                            Name = "APP",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 598, DateTimeKind.Local).AddTicks(7036)
                        });
                });
            ...
            modelBuilder.Entity("Models.CustomerBillType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("67b337c8-df5f-44ae-b5b0-f975d4b803ab"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(5825),
                            IsActive = false,
                            NameAR = "تيكاوى",
                            NameEN = "TEKAWAY",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(6556)
                        },
                        new
                        {
                            Id = new Guid("0ffda92f-b741-4062-9628-746826d846b1"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(8363),
                            IsActive = false,
                            NameAR = "دليفرى",
                            NameEN = "DELIVERY",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(8377)
                        },
                        new
                        {
                            Id = new Guid("cea19aa6-f63e-4269-8670-fad7f0548996"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(8383),
                            IsActive = false,
                            NameAR = "سفرة",
                            NameEN = "TABLE",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 601, DateTimeKind.Local).AddTicks(8385)
                        });
                });
            ...
            modelBuilder.Entity("Models.TaxationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("afe10450-7bf0-4283-ba4f-0c941ed904df"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(1800),
                            IsActive = false,
                            Name = "PERCENT",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(2450)
                        },
                        new
                        {
                            Id = new Guid("a0fce33d-7374-4988-a6fb-b114c7a65898"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(3613),
                            IsActive = false,
                            Name = "FIXED",
                            UpdatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(3622)
                        });
                });
            ...
            modelBuilder.Entity("Models.UserType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ce8ee94-6c0a-4393-8482-dbecef2f3190"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(6996),
                            IsActive = false,
                            NameAR = "مدير",
                            NameEN = "ADMIN",
                        ...
                        new
                        {
                            Id = new Guid("6f32976a-85fe-4ae8-9a1f-5e13eff398be"),
                            CreatedAt = new DateTime(2021, 6, 8, 21, 54, 54, 602, DateTimeKind.Local).AddTicks(8155),
                            IsActive = false,
                            NameAR = "كاشير",
                            NameEN = "CASHER",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
